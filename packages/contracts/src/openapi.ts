...
const CHEMINS: Chemin[] = [
  ...
  // (`topup.provider`) attend une intégration de prestataire.
  {
    ...
    note: [
      ...
      "",
      "`bonusPercent` est **nul** quand il n'y en a pas — la ligne ne doit alors",
      "pas exister, jamais « +0 % ».",
      "",
