...
const CHEMINS: Chemin[] = [
  ...
  },
  {
    ...
    note: [
      ...
      "",
      "### Aucun reçu n'est demandé",
      "",
      "C'est une décision, pas un oubli : *« le reçu ne prouve rien — un montage",
      "est facile ; c'est la réception sur le compte de l'opérateur qui fait",
      "foi »*. Ce qui le remplace est plus utile — `payerMsisdn`, le numéro",
      "depuis lequel le versement a été fait, qui permet de retrouver la",
      "transaction sur le relevé.",
      "",
