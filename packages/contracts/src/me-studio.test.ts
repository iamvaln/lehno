  ...
  groups: [
    {
      ...
      choices: [
        { id: "relation", label: "La relation", description: null, warning: null, revealsGroup: null, previewUrl: null },
        {
          id: "tribute", label: "Hommage", description: null,
          warning: "Le ton change : palette froide, aucune illustration vive.",
          revealsGroup: null, previewUrl: null,
        },
      ],
    },
    {
      ...
      choices: [
        { id: "illustration", label: "Une illustration", description: null, warning: null, revealsGroup: "family", previewUrl: null },
        { id: "photo", label: "Une photo", description: null, warning: null, revealsGroup: "photoStyle", previewUrl: null },
        { id: "none", label: "Aucune image", description: null, warning: null, revealsGroup: null, previewUrl: null },
      ],
    },
    {
      id: "family",
      ...
      choices: [{ id: "nature", label: "Nature", description: null, warning: null, revealsGroup: null, previewUrl: null }],
    },
    {
      id: "photoStyle",
      label: "Le style",
      defaultChoiceId: "silhouette",
      choices: [{ id: "silhouette", label: "Silhouette", description: null, warning: null, revealsGroup: null, previewUrl: null }],
    },
  ],
