  ...
  return (
    ...
    >
      ...
      {solde !== null ? (
        <Card surface="panel" padding={15} radius="lg">
          <View style={styles.soldeLigne}>
            ...
            <Button onPress={() => routeur.push("/recharge")}>{t.moiRecharger}</Button>
          </View>
        </Card>
      ) : null}
          ...
          {mur ? (
            <Card surface="panel" padding={13} radius="lg" style={styles.carte}>
              <View style={styles.ligne}>
                ...
                <Pressable
                  accessibilityRole="button"
                  onPress={() => routeur.push("/(app)/moi/monmur")}
                  style={styles.pleine}
                >
                ...
                {adresseDuMur ? (
                  ...
                  <Button variant="text" onPress={() => routeur.push("/(app)/moi/monmur")}>
                    {t.moiPublierMur}
                  </Button>
                )}
              </View>
          ...
          {listes !== null ? (
            <Card surface="panel" padding={13} radius="lg" style={styles.carte}>
              <View style={styles.ligne}>
                ...
                <Button variant="text" onPress={() => routeur.push("/listes")}>
      ...
      {montreCeQuiRevient(actives) ? (
        <View style={styles.groupe}>
          ...
          {estActive(actives, "reservation") ? (
            <Pressable
              accessibilityRole="button"
              onPress={() => routeur.push("/(app)/moi/reservations")}
              style={[styles.rang, { borderTopColor: couleurs.borderHairline }]}
            >
      ...
      {estActive(actives, "referral") ? (
        <Pressable
          accessibilityRole="button"
          onPress={() => routeur.push("/(app)/moi/parrainage")}
          style={[styles.rang, { borderTopColor: couleurs.borderHairline }]}
        >
