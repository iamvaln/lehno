  ...
  const bandeau = (
    <View style={styles.bandeau}>
      ...
      <NotificationBell
        ...
        onPress={() => routeur.push("/(app)/accueil/notifications")}
      />
    </View>
  );
              ...
              <View key={e.id} style={{ marginBottom: nativeSpace[12] }}>
                <EventCard
                  ...
                  onPress={() => routeur.push({
                    pathname: "/occasion", params: { occurrenceId: e.id },
                  })}
                  {...(rang === 0 ? (gesteDeLaCarte(e, preparer) === "liste" ? {
                    ...
                    onPrepare: () => routeur.push({
                      pathname: "/preparation", params: { occurrenceId: e.id },
                    }),
                  } : {
