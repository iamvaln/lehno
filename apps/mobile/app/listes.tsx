...
export default function Listes() {
  ...
  // §8 du relevé des essais : tirer-pour-rafraîchir partout où l'écran lit
              ...
              <Card key={l.id} surface="panel" padding={15} radius="lg" style={styles.carte}>
                <Pressable
                  ...
                  onPress={() => routeur.push({
                    pathname: "/souhaits", params: { id: l.id, nom: nomDeLaListe(l, t) },
                  })}
                  style={styles.entete}
                >
                  <View style={styles.pleine}>
                ...
                {peutPartager(l) ? (
                  <View style={{ marginTop: nativeSpace[10] }}>
                    <Button
                      ...
                      icon="eye"
                      onPress={() => routeur.push({
                        pathname: "/apercu-liste", params: { id: l.id },
                      })}
                    >
                      {t.listeApercu}
                    </Button>
