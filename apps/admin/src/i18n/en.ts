...
export const en: typeof fr = {
  ...
  motifs: {
    titre: "Audit reasons",
    sous: "What gets offered when an action asks for a reason. A code is retired, never renamed.",
    ajouter: "Add a reason",
    modifier: "Edit",
    enService: "In service",
    retire: "Retired",
    aucunGeste: "No action",
    col: { code: "Code", fr: "French", en: "English", gestes: "Actions", etat: "State" },
    champs: {
      code: "Code",
      codeAide: "Lowercase, digits and underscores. It is never renamed: it is what gets counted.",
      codeFige: "It identifies this reason across the whole history. Renaming it would cut in two what it justified.",
      codeFaux: "A letter first, then letters, digits or underscores.",
      fr: "French label",
      en: "English label",
      gestes: "Actions covered",
      gestesAide: "Comma separated — for example: parameter_update, credit_adjust. A reason outside an action's scope is refused when used.",
      actif: "In service",
      actifAide: "Retired, it stops being offered. What it already justified stays readable.",
    },
    vide: {
      titre: "No reason",
      texte: "The reasons offered to administration actions appear here.",
    },
    dialogue: {
      titreCreation: "Add this reason",
  ...
  studioTextes: {
    titre: "Text workshop",
    sous: "What the model reads before writing — for the message, the gift ideas and the portrait brief.",
    natures: { message: "Message", idees: "Gift ideas", portrait_brief: "Portrait brief" },
    modeleEteint: "out of routing",
    enService: { titre: "In service", version: "Version", aucune: "Nothing published yet for this kind." },
    champs: {
      consigne: "Shared instruction",
      consigneAide: "What is ADDED to the system instruction. Absolute rules are not set from here.",
      gardeFous: "Guardrails",
      gardeFousAide: "What is ruled out: symbols, formulas, turns of phrase. Enter to add, cross to remove.",
      retirer: "Remove",
      champsDuProche: "What the model receives",
      champsDuProcheAide: "What leaves our hands. Unticking “notes” decides that confidences do not travel.",
      modele: "Model called",
      modeleAide: "A model out of routing still appears: this is where you come to see whether it is back.",
      nombreDemande: "Ideas asked for",
      nombreDemandeAide: "Three to six. Below, nothing to compare and one refusal empties the list; above, the last ones become variants of the first.",
      motsDuPortrait: "Cloud words",
      motsDuPortraitAide: "One to twelve. Too few says nothing; too many drowns the drawing.",
      motsDeLaPhrase: "Dedication words",
      motsDeLaPhraseAide: "Two to twenty-four. This is a COMPOSITION constraint: beyond it the third line overflows the band and the dedication comes out cut.",
      profil: "Test tube",
      profilAide: "The simulation profile the trial runs on.",
    },
    bornes: { min: "Minimum", max: "Maximum" },
    champsProche: { relation: "Relation", age: "Age", notes: "Notes", texte_libre: "Free text" },
    orientations: {
      titre: "Angles",
      aide: "The order is the one on screen, and the first active one is the default. There is no “default” field: you set it by reordering.",
      active: "Active",
      defaut: "Default",
      monter: "Move up",
      descendre: "Move down",
      aucuneActive: "At least one angle must stay active: without it the client screen has nothing to offer.",
    },
    essai: { titre: "Last trial", etat: "State:", cout: "Cost:", coutInconnu: "not priced" },
    etats: { success: "succeeded", error: "errored", timeout: "timed out", refused: "refused" },
    sansProfil: {
      titre: "No test tube",
      texte: "Without a simulation profile no trial is possible — and nothing publishes without a trial.",
    },
    gestes: {
      enregistrer: "Save the draft",
      essayer: "Try",
    ...
    blocages: {
      ...
      etat_depasse: "This version is superseded: you do not publish it, you roll back to it.",
    },
    dialoguePublier: {
      titre: "Put these settings in service",
      consequence: "The next generation will use these settings. Work already produced does not change.",
      motifs: ["Trial convincing", "Fixing an instruction", "Following a reported case"],
      note: "What changes",
