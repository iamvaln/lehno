...
// Requesting an account deletion — the English page.
//
// The path is in the language of the page, like the legal pages and for the
// same reason: a English word in the address bar of a reader who does not
// speak it, and a English page indexed under a foreign URL. The other
// language lives at `/fr/supprimer-mon-compte`.
//
...
// Anything but "en" is a 404 rather than a page served under the wrong
...
export default async function Page({ params }: Proprietes): Promise<ReactNode> {
  ...
  return <AccountDeletionPage t={messages("en")} langue="en" />;
}
