...
// La politique de confidentialité, en anglais.
//
...
// langue-là, et dynamicParams la ferme aux autres — « /fr/privacy » n'a pas
...
export default async function Page({ params }: Proprietes): Promise<ReactNode> {
  ...
  const document = await chargerDocumentLegal("confidentialite", langue, 0);
