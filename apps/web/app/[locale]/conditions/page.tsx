...
// Le texte des conditions change rarement — un document juridique ne se corrige pas au fil
// de la journée. Un cache d'une heure évite un aller-retour à l'API à chaque visite.
//
...
export default async function Page({ params }: Proprietes): Promise<ReactNode> {
  ...
  const document = await chargerDocumentLegal("cgu", langue, 0);
