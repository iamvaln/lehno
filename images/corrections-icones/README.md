...
| `lehno-favicon-28.svg` | Favicon — même tracé, trait épaissi |
| `lehno-verrouillage-horizontal.svg` | Signe + mot, en ligne |
| `lehno-verrouillage-horizontal-inverse.svg` | Idem, sur plaque d'encre — mot blanc, `h` abricot |
...
2. **Un seul tracé, un trait qui s'adapte.** Tous les paliers viennent des courbes de
   `lehno-icone-512.svg`. Sous 128 px, seul l'épaisseur du trait change — calculée sur le
   canal entre la hampe et la jambe droite, et bornée au quart de sa largeur pour qu'il
   reste ouvert. Ne réduisez pas le fichier 512 : demandez le palier.
